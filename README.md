...
1. [Security Groups](#1️⃣--security-groups---criação)  
2. [VPC - Virtual Private Cloud](#2️⃣-️-vpc---virtual-private-cloud)  
3. [EFS - Elastic File System](#3️⃣--efs---elastic-file-system)  
4. [RDS - Relational Database](#4️⃣--rds---relational-database)  
5. [Instância EC2 e User Data](#5️⃣-️-instância-ec2-e-user-data)  
6. [Acesso ao EC2 e Bastion Host](#6️⃣--acesso-ao-ec2-e-bastion-host)  
7. [Load Balancer](#7️⃣-️-load-balancer)  
8. [ASG - Auto Scaling Group](#8️⃣-️-asg---auto-scaling-group)  
9. [Conclusão](#-conclusão)



### 1️⃣ 🔐 Security Groups - Criação
...
### 2️⃣ ☁️ VPC - Virtual Private Cloud 
...
### 5️⃣ 🗝️ Instância EC2 e User Data
...
### 6️⃣ 🔓 Acesso ao EC2 e Bastion Host
